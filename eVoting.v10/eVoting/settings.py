...
SECRET_KEY = 'django-insecure-)8acm#3c#21kse2w@^9z=t^wmssaqbr8z5v+(4j+_eku_o&)_#'
...
print("Template Directory:", os.path.join(BASE_DIR, 'voting/templates'))
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'evoting.nu@gmail.com'
EMAIL_HOST_PASSWORD = 'hupinjhhohxqwjui'  
...
AUTHENTICATION_BACKENDS = [
    "voting.models.EmailAuthBackend",  # تأكد أن المسار صحيح
    "django.contrib.auth.backends.ModelBackend",  # احتياطيًا دعم الطريقة الافتراضية
]
